...
COIN_TGZ='https://github.com/htrcoin/htrcoin/releases/download/v1020/HighTemperature-qt_v1020.zip'
...
purgeOldInstallation() {
    ...
    #kill wallet daemon
	sudo killall HighTemperatured > /dev/null 2>&1
    #remove old ufw port allow
    sudo ufw delete allow 11368/tcp > /dev/null 2>&1
    #remove old files
    if [ -d "~/.HighTemperature" ]; then
        sudo rm -rf ~/.HighTemperature > /dev/null 2>&1
    fi
    #remove binaries and HighTemperature utilities
    cd /usr/local/bin && sudo rm HighTemperature-cli HighTemperature-tx HighTemperatured > /dev/null 2>&1 && cd
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/Realbityoda/HTRCoin/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
